...
function About() {
  return (
    <>
      <section className=" flex flex-col py-8 md:flex-row items-center justify-between gap-8 px-8 sm:px-10 md:px-14 lg:px-16 ">
        <div className="basis-1/2 w-full flex flex-col ">
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-1 relative bg-limelight rounded-3xl ">
            ...
            <img src="./img/project2.jpg" alt="Work" className="rounded-3xl object-cover shadow-lg border-4 border-white/50" />
        ...
        <div className="basis-1/2 flex flex-col  gap-6 backdrop-blur-sm transition-all duration-300">
